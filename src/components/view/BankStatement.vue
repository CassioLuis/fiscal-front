...
<template>
  <div class="grow grid grid-cols-12">
    <div class="col-span-12 grid grid-cols-12 mx-auto content-start xl:mx-32">
      <!-- Page header -->
      <div class="col-span-12 grid grid-cols-12 mb-5">
        ...
        <div class="col-span-12 sm:col-span-6 justify-self-start sm:justify-self-end">
          <InputFile
            :formats="['.pdf', '.ofx', '.xls']"
      ...
      <!-- Filters -->
      <div class="col-span-12 flex justify-start sm:justify-end gap-2 mb-5">
      ...
      <div
        ...
        class="h-[73vh] col-span-12 relative flex justify-start py-4 border-t border-slate-200 dark:border-slate-700"
      >
        <DragAndDrop
